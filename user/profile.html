    ...
    <body style="background-color: #e7f0ff;">
      ...
      <nav class="navbar" style="background-color: #4392f1;">
        <div class="container-fluid">
          ...
          <a class="align-right navbar-brand text-white" href="/unifind/user/profile.html"><img class="img-fluid rounded-circle" src="/unifind/assets/images/marwoto.jpg" alt="profile picture" style="width: 30px;"> Marwoto</a>
        </div>
      </nav>
...
<div class="container justify-content-center" style="width:90%; margin-left:15%">

    <div class="row" >
        <div class="col-3">
            <div class="card mt-5 shadow-sm p-3 mb-5 bg-body rounded">
                <div class="card-body p-4">
                    <img class="img-fluid rounded-circle" src="/unifind/assets/images/marwoto.jpg" alt="Trendy Pants and Shoes"
        ...
        <div class="col-7">
            <div class="card mt-5 shadow-sm p-3 mb-5 bg-body rounded">        
                ...
                <a class="btn btn-secondary" style="width:6%; margin-bottom: -1.5%; align-self: flex-end;" href="/unifind/user/profile-edit.html"><i class="bi bi-pencil-fill"></i></a>
                ...
                <div class="card-body p-4">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>: marwoto@gmail.com</td>
                        </tr>
                        <tr>
                            <td style="font-weight:bold">Asal sekolah</td>
                            <td>: SMAN 1 Darul Gulag</td>
                        </tr>
                        <tr>
