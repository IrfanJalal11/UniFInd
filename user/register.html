...
<body style="background-color: #e7f0ff;">
  ...
  <nav class="navbar" style="background-color: #4392f1;">
    <div class="container-fluid">
      ...
      <a class="align-right navbar-brand text-white" href="/unifind/user/login.html"><img src="/unifind/assets/images/account.png" alt="profile picture" style="width: 30px;"> Login / Register</a>
    </div>
  </nav>
...
<div class="card mt-5 shadow-sm p-3 mb-5 bg-body rounded" style="width:40%; margin-left:30%">
<div class="card-body p-4">
    <!-- Pills navs -->
<ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
    <li class="nav-item" role="presentation">
      <a class="nav-link" id="tab-login" data-mdb-toggle="pill" href="/unifind/user/login.html" role="tab"
        aria-controls="pills-login" aria-selected="false">Login</a>
    </li>
    <li class="nav-item" role="presentation">
      <a class="nav-link active" id="tab-register" data-mdb-toggle="pill" href="/unifind/user/register.html" role="tab"
    ...
    <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
      <form>
        ...
        <div class="form-outline mb-4">
          <input type="text" id="loginName" placeholder="Nama" class="form-control" />
        ...
        <!-- Password input -->
        <div class="form-outline mb-4">
          <input type="password" id="loginPassword" placeholder="Repeat password"class="form-control" />
          <!--<label class="form-label" for="loginPassword">Password</label> -->
        </div>
        ...
        <div class="row mb-4">
          <div class=" d-flex justify-content-center">
            ...
            <div class="form-check mb-3 mb-md-0">
              ...
              <label class="form-check-label" for="loginCheck"> I have read and agree with the terms & conditions </label>
            </div>
          </div>
        </div>
  
        <!-- Submit button -->
        <a href="/unifind/index.php" type="submit" class="btn btn-primary btn-block" style="width: 100%">Sign in</a>
      </form>
    </div>
  </div>
  <!-- Pills content -->  
